...
class OreProvider_Normal extends OreProvider {
	...
	public OreProvider_Normal(CityWorldGenerator generator) {
		...
		ore_types.add(
				generator.materialProvider.itemsMaterialListFor_NormalOres.getNthMaterial(9, Material.COPPER_ORE));
		ore_types.add(
				generator.materialProvider.itemsMaterialListFor_NormalOres.getNthMaterial(10, Material.EMERALD_ORE));
	}
}
